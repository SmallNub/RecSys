...
# Categories and Curvatures to run
...
# Original dataset and checkpoint dirs
...
for CATEGORY in "${CATEGORIES[@]}"; do
    ...
    for C_VAL in "${C_VALUES[@]}"; do
        ...
        for RUN_IDX in $(seq 1 ${N_RUNS}); do
            ...
            # Step 1: Train COSETTE (Hyperbolic)
            ...
            # Step 3: Resolve quant_id from parquet output (Looking for Hyperbolic prefix)
            QUANT=$(python -c "
...
echo "================================================================"
echo "All categories, curvatures, and MARIUS pipelines complete."
echo "================================================================"